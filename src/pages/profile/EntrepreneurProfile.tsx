...
export const EntrepreneurProfile: React.FC = () => {
  ...
  const deal = deals.find((d) => d.startup.name === entrepreneur.startupName);
  return (
                ...
                {deal && (
                  <div className="space-y-2 mt-4">
                    <div className="flex justify-between text-sm text-gray-600">
                      <span>Funded: ${deal.fundedAmount.toLocaleString()}</span>
                      <span>Target: ${deal.targetAmount.toLocaleString()}</span>
                    </div>
